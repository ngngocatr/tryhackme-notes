...
## **6. Extra-miles Challenge**

<img src="./images/2026-07-21-20-34-28.png" style="display: block; margin: 0 auto;">

- Đề cho ta 1 trang web hiển thị thông tin của người dùng

<img src="./images/2026-07-21-20-35-41.png" style="display: block; margin: 0 auto;">
- Khi ta chuyển đến id = 1, đọc thông tin của người này là CEO của tổ chức nằy

<img src="./images/2026-07-21-20-36-25.png" style="display: block; margin: 0 auto;">

- Khi ta thêm dấu `'`, ta thấy web trả về lỗi và câu lện truy vấn

- Ta thấy được, trong đây có những trường tương ứng được hiển thị với bảng `people`

- Đây là dạng Error-base SQLi, ta sử dụng mệnh đề `UNION` và `group_concat()` để xác định được tất cả các cột trong bảng `people`: 
```sql
0 UNION SELECT group_concat(column_name),2,3,4,5 FROM information_schema.columns WHERE table_name='people'--
```
<img src="./images/2026-07-21-21-02-38.png" style="display: block; margin: 0 auto;">

- Ta thấy được tất cả các cột trong bảng `people` nhiệm vụ là in tất cả chúng ra màn hình để xem flag 
```sql
0 UNION SELECT firstName,lastName,pfpLink,shortRole,notes FROM people WHERE id='1'--  
```

<img src="./images/2026-07-21-21-05-40.png" style="display: block; margin: 0 auto;">
